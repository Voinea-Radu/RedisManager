...
![Version](https://img.shields.io/badge/Version-1.15.4-red.svg)
...
```groovy
dependencies {
    implementation "dev.lightdream:redis-manager:1.15.4"
}
```
  </details>
...
```groovy
dependencies {
    implementation "com.github.L1ghtDream:redis-manager:1.15.4"
}
```
  </details>
</blockquote></details>
