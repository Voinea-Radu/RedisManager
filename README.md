...
![Version](https://img.shields.io/badge/Version-2.0.10-red.svg)
...
dependencies {
    implementation "dev.lightdream:redis-manager:2.0.10"
    implementation "com.github.L1ghtDream:redis-manager:2.0.10"
}
```
