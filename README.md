...
![Version](https://img.shields.io/badge/Version-4.0.23-red.svg)
...
dependencies {
    implementation "dev.lightdream:redis-manager:4.0.23"
    implementation "com.github.L1ghtDream:redis-manager:4.0.23"
}
```
