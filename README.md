...
![Version](https://img.shields.io/badge/Version-1.13.1-red.svg)
...
```groovy
dependencies {
    implementation "dev.lightdream:redis-manager:1.13.1"
}
```
  </details>
...
```groovy
dependencies {
    implementation "com.github.L1ghtDream:redis-manager:1.13.1"
}
```
  </details>
</blockquote></details>
