...
![Version](https://img.shields.io/badge/Version-1.14.2-red.svg)
...
```groovy
dependencies {
    implementation "dev.lightdream:redis-manager:1.14.2"
}
```
  </details>
...
```groovy
dependencies {
    implementation "com.github.L1ghtDream:redis-manager:1.14.2"
}
```
  </details>
</blockquote></details>
